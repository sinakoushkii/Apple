...
const Card = ({ title, subTitle, img, mainImg, description,showCardModalHandler }) => {
  return (
    <div>
      <div className="card">
        ...
        <img className="card__plus-btn" width={30} height={30} src={plusBtn} onClick={()=>showCardModalHandler()} />
      </div>
    </div>
  );
};
